...
int main(int argc, char const *argv[])
{
    ...
    #pragma omp target enter data map(to: u[0:size_u[0] * size_u[1]])
    ...
    #pragma omp target update from(u[0:size_u[0] * size_u[1]])
    #pragma omp target exit data map(release: u[0:size_u[0] * size_u[1]])
